...
declare namespace Visio {
    ...
    class AboveAverage {
        private "Visio.AboveAverage_typekey": AboveAverage;
        private constructor();
    ...
    class Action {
        private "Visio.Action_typekey": Action;
        private constructor();
        readonly Application: Application;
    ...
    class AddIn {
        private "Visio.AddIn_typekey": AddIn;
        private constructor();
        readonly Application: Application;
    ...
    class AllowEditRange {
        private "Visio.AllowEditRange_typekey": AllowEditRange;
        private constructor();
    ...
    class Application {
         ...
         *
         * Returns `false` if Microsoft Visio has control of the status bar.
         *
    ...
    class AutoCorrect {
        private "Visio.AutoCorrect_typekey": AutoCorrect;
        private constructor();
    ...
    class AutoFilter {
        private "Visio.AutoFilter_typekey": AutoFilter;
        private constructor();
        readonly Application: Application;
        ApplyFilter(): void;
        readonly Creator: XlCreator;
    ...
    class AutoRecover {
        private "Visio.AutoRecover_typekey": AutoRecover;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Enabled: boolean;
    ...
    class Axis {
        private "Visio.Axis_typekey": Axis;
        private constructor();
        readonly Application: Application;
    ...
    class AxisTitle {
        private "Visio.AxisTitle_typekey": AxisTitle;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        readonly Border: Border;
    ...
    class Border {
        private "Visio.Border_typekey": Border;
        private constructor();
        readonly Application: Application;
    ...
    class CalculatedMember {
        private "Visio.CalculatedMember_typekey": CalculatedMember;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class CalloutFormat {
        private "Visio.CalloutFormat_typekey": CalloutFormat;
        private constructor();
    ...
    class CellFormat {
        private "Visio.CellFormat_typekey": CellFormat;
        private constructor();
        AddIndent: boolean;
        readonly Application: Application;
        Borders: Borders;
    ...
    class Characters {
        private "Visio.Characters_typekey": Characters;
        private constructor();
        readonly Application: Application;
        Caption: string;
        readonly Count: number;
    ...
    class Chart {
        private "Visio.Chart_typekey": Chart;
        private constructor();
        __PrintOut(
            From?: any,
            To?: any,
    ...
    class ChartArea {
        private "Visio.ChartArea_typekey": ChartArea;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        readonly Border: Border;
    ...
    class ChartColorFormat {
        private "Visio.ChartColorFormat_typekey": ChartColorFormat;
        private constructor();
    ...
    class ChartFillFormat {
        private "Visio.ChartFillFormat_typekey": ChartFillFormat;
        private constructor();
        readonly Application: Application;
    ...
    class ChartFormat {
        private "Visio.ChartFormat_typekey": ChartFormat;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class ChartGroup {
        private "Visio.ChartGroup_typekey": ChartGroup;
        private constructor();
        readonly Application: Application;
    ...
    class ChartObject {
        private "Visio.ChartObject_typekey": ChartObject;
        private constructor();
        _Copy(): any;
        Activate(): any;
        readonly Application: Application;
    ...
    class ChartTitle {
        private "Visio.ChartTitle_typekey": ChartTitle;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        readonly Border: Border;
    ...
    class ColorFormat {
        private "Visio.ColorFormat_typekey": ColorFormat;
        private constructor();
        readonly Application: any;
        Brightness: number;
        readonly Creator: number;
    ...
    class ColorScale {
        private "Visio.ColorScale_typekey": ColorScale;
        private constructor();
        readonly Application: Application;
        readonly AppliesTo: Range;
    ...
    class ColorScaleCriterion {
        private "Visio.ColorScaleCriterion_typekey": ColorScaleCriterion;
        private constructor();
    ...
    class Comment {
        private "Visio.Comment_typekey": Comment;
        private constructor();
        readonly Application: Application;
        readonly Author: string;
        readonly Creator: XlCreator;
    ...
    class ConditionValue {
        private "Visio.ConditionValue_typekey": ConditionValue;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Modify(
    ...
    class ConnectorFormat {
        private "Visio.ConnectorFormat_typekey": ConnectorFormat;
        private constructor();
        readonly Application: Application;
    ...
    class ControlFormat {
        private "Visio.ControlFormat_typekey": ControlFormat;
        private constructor();
        _Default: number;
    ...
    class Corners {
        private "Visio.Corners_typekey": Corners;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        readonly Name: string;
    ...
    class CubeField {
        private "Visio.CubeField_typekey": CubeField;
        private constructor();
    ...
    class CustomProperty {
        private "Visio.CustomProperty_typekey": CustomProperty;
        private constructor();
    ...
    class CustomView {
        private "Visio.CustomView_typekey": CustomView;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Delete(): void;
    ...
    class Databar {
        private "Visio.Databar_typekey": Databar;
        private constructor();
        readonly Application: Application;
        readonly AppliesTo: Range;
    ...
    class DataBarBorder {
        private "Visio.DataBarBorder_typekey": DataBarBorder;
        private constructor();
        readonly Application: Application;
    ...
    class DataLabel {
        private "Visio.DataLabel_typekey": DataLabel;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        AutoText: boolean;
    ...
    class DataTable {
        private "Visio.DataTable_typekey": DataTable;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        readonly Border: Border;
    ...
    class DefaultWebOptions {
        private "Visio.DefaultWebOptions_typekey": DefaultWebOptions;
        private constructor();
        AllowPNG: boolean;
    ...
    class Diagram {
        private "Visio.Diagram_typekey": Diagram;
        private constructor();
        readonly Application: Application;
    ...
    class DiagramNode {
        private "Visio.DiagramNode_typekey": DiagramNode;
        private constructor();
    ...
    class Dialog {
        private "Visio.Dialog_typekey": Dialog;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        readonly Parent: any;
    ...
    class DialogFrame {
        private "Visio.DialogFrame_typekey": DialogFrame;
        private constructor();
        readonly Application: Application;
        Caption: string;
    ...
    class DisplayFormat {
        private "Visio.DisplayFormat_typekey": DisplayFormat;
        private constructor();
    ...
    class DisplayUnitLabel {
        private "Visio.DisplayUnitLabel_typekey": DisplayUnitLabel;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        readonly Border: Border;
    ...
    class DownBars {
        private "Visio.DownBars_typekey": DownBars;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        readonly Creator: XlCreator;
    ...
    class DropLines {
        private "Visio.DropLines_typekey": DropLines;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        readonly Creator: XlCreator;
    ...
    class Error {
        private "Visio.Error_typekey": Error;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Ignore: boolean;
    ...
    class ErrorBars {
        private "Visio.ErrorBars_typekey": ErrorBars;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        ClearFormats(): any;
    ...
    class ErrorCheckingOptions {
        private "Visio.ErrorCheckingOptions_typekey": ErrorCheckingOptions;
        private constructor();
        readonly Application: Application;
    ...
    class FileExportConverter {
        private "Visio.FileExportConverter_typekey": FileExportConverter;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class FillFormat {
        private "Visio.FillFormat_typekey": FillFormat;
        private constructor();
        readonly Application: any;
    ...
    class Filter {
        private "Visio.Filter_typekey": Filter;
        private constructor();
    ...
    class Floor {
        private "Visio.Floor_typekey": Floor;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        ClearFormats(): any;
    ...
    class Font {
        private "Visio.Font_typekey": Font;
        private constructor();
        readonly Application: Application;
    ...
    class FormatColor {
        private "Visio.FormatColor_typekey": FormatColor;
        private constructor();
        readonly Application: Application;
        Color: XlRgbColor | number;
    ...
    class FormatCondition {
        private "Visio.FormatCondition_typekey": FormatCondition;
        private constructor();
    ...
    class FreeformBuilder {
        private "Visio.FreeformBuilder_typekey": FreeformBuilder;
        private constructor();
        AddNodes(
    ...
    class Graphic {
        private "Visio.Graphic_typekey": Graphic;
        private constructor();
        readonly Application: Application;
        Brightness: number;
    ...
    class Gridlines {
        private "Visio.Gridlines_typekey": Gridlines;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        readonly Creator: XlCreator;
    ...
    class GroupObject {
        private "Visio.GroupObject_typekey": GroupObject;
        private constructor();
        _Default: number;
        AddIndent: boolean;
        readonly Application: Application;
    ...
    class HeaderFooter {
        private "Visio.HeaderFooter_typekey": HeaderFooter;
        private constructor();
    ...
    class HiLoLines {
        private "Visio.HiLoLines_typekey": HiLoLines;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        readonly Creator: XlCreator;
    ...
    class HPageBreak {
        private "Visio.HPageBreak_typekey": HPageBreak;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Delete(): void;
    ...
    class Hyperlink {
        private "Visio.Hyperlink_typekey": Hyperlink;
        private constructor();
        Address: string;
        AddToFavorites(): void;
        readonly Application: Application;
    ...
    class Icon {
        private "Visio.Icon_typekey": Icon;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        readonly Index: number;
    ...
    class IconSetCondition {
        private "Visio.IconSetCondition_typekey": IconSetCondition;
        private constructor();
        readonly Application: Application;
        readonly AppliesTo: Range;
        readonly Creator: XlCreator;
    ...
    class IconCriterion {
        private "Visio.IconCriterion_typekey": IconCriterion;
        private constructor();
        Icon: XlIcon;
        readonly Index: number;
        Operator: number;
    ...
    class Interior {
        private "Visio.Interior_typekey": Interior;
        private constructor();
        readonly Application: Application;
        Color: XlRgbColor | number;
        ColorIndex: number | XlColorIndex;
    ...
    class LeaderLines {
        private "Visio.LeaderLines_typekey": LeaderLines;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        readonly Creator: XlCreator;
    ...
    class Legend {
        private "Visio.Legend_typekey": Legend;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        readonly Border: Border;
    ...
    class LegendEntry {
        private "Visio.LegendEntry_typekey": LegendEntry;
        private constructor();
        readonly Application: Application;
        AutoScaleFont: any;
        readonly Creator: XlCreator;
    ...
    class LegendKey {
        private "Visio.LegendKey_typekey": LegendKey;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        ClearFormats(): any;
    ...
    class LineFormat {
        private "Visio.LineFormat_typekey": LineFormat;
        private constructor();
        readonly Application: any;
        BackColor: ColorFormat;
    ...
    class LinkFormat {
        private "Visio.LinkFormat_typekey": LinkFormat;
        private constructor();
        readonly Application: Application;
        AutoUpdate: boolean;
        readonly Creator: XlCreator;
    ...
    class ListColumn {
        private "Visio.ListColumn_typekey": ListColumn;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class ListDataFormat {
        private "Visio.ListDataFormat_typekey": ListDataFormat;
        private constructor();
    ...
    class ListObject {
        private "Visio.ListObject_typekey": ListObject;
        private constructor();
        readonly _Default: string;
    ...
    class ListRow {
        private "Visio.ListRow_typekey": ListRow;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Delete(): void;
    ...
    /** Macintosh only */
    class Mailer {
        private "Visio.Mailer_typekey": Mailer;
        private constructor();
        readonly Application: Application;
        BCCRecipients: any;
        CCRecipients: any;
    ...
    class Menu {
        private "Visio.Menu_typekey": Menu;
        private constructor();
        readonly Application: Application;
        Caption: string;
        readonly Creator: XlCreator;
    ...
    class MenuBar {
        private "Visio.MenuBar_typekey": MenuBar;
        private constructor();
        Activate(): void;
        readonly Application: Application;
    ...
    class MenuItem {
        private "Visio.MenuItem_typekey": MenuItem;
        private constructor();
        readonly Application: Application;
        Caption: string;
        Checked: boolean;
    ...
    class Module {
        private "Visio.Module_typekey": Module;
        private constructor();
        __PrintOut(
            From?: any,
            To?: any,
    ...
    class MultiThreadedCalculation {
        private "Visio.MultiThreadedCalculation_typekey": MultiThreadedCalculation;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Enabled: boolean;
    ...
    class Name {
        private "Visio.Name_typekey": Name;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        Category: string;
    ...
    class NegativeBarFormat {
        private "Visio.NegativeBarFormat_typekey": NegativeBarFormat;
        private constructor();
        readonly Application: Application;
    ...
    class ODBCConnection {
        private "Visio.ODBCConnection_typekey": ODBCConnection;
        private constructor();
    ...
    class ODBCError {
        private "Visio.ODBCError_typekey": ODBCError;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class OLEDBConnection {
        private "Visio.OLEDBConnection_typekey": OLEDBConnection;
        private constructor();
    ...
    class OLEDBError {
        private "Visio.OLEDBError_typekey": OLEDBError;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        readonly ErrorString: string;
    ...
    class OLEFormat {
        private "Visio.OLEFormat_typekey": OLEFormat;
        private constructor();
        Activate(): void;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class OLEObject {
        private "Visio.OLEObject_typekey": OLEObject;
        private constructor();
        Activate(): any;
        AltHTML: string;
        readonly Application: Application;
    ...
    class OLEObjects {
        private "Visio.OLEObjects_typekey": OLEObjects;
        private constructor();
        Add(
            ClassType: string,
            Filename: undefined,
    ...
    class Outline {
        private "Visio.Outline_typekey": Outline;
        private constructor();
        readonly Application: Application;
    ...
    class PageSetup {
        private "Visio.PageSetup_typekey": PageSetup;
        private constructor();
    ...
    class Pane {
        private "Visio.Pane_typekey": Pane;
        private constructor();
        Activate(): boolean;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class Parameter {
        private "Visio.Parameter_typekey": Parameter;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class Phonetic {
        private "Visio.Phonetic_typekey": Phonetic;
        private constructor();
        Alignment: number;
        readonly Application: Application;
    ...
    class PictureFormat {
        private "Visio.PictureFormat_typekey": PictureFormat;
        private constructor();
        readonly Application: any;
        Brightness: number;
        ColorType: Office.MsoPictureColorType;
    ...
    class PivotAxis {
        private "Visio.PivotAxis_typekey": PivotAxis;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        readonly Parent: any;
    ...
    class PivotCache {
        private "Visio.PivotCache_typekey": PivotCache;
        private constructor();
        readonly ADOConnection: ADODB.Connection;
        readonly Application: Application;
        BackgroundQuery: boolean;
    ...
    class PivotCell {
        private "Visio.PivotCell_typekey": PivotCell;
        private constructor();
        AllocateChange(): void;
        readonly Application: Application;
    ...
    class PivotField {
        private "Visio.PivotField_typekey": PivotField;
        private constructor();
    ...
    class PivotFields {
        private "Visio.PivotFields_typekey": PivotFields;
        private constructor();
        readonly Application: Application;
        readonly Count: number;
        readonly Creator: XlCreator;
    ...
    class PivotFilter {
        private "Visio.PivotFilter_typekey": PivotFilter;
        private constructor();
        readonly Active: boolean;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class PivotFormula {
        private "Visio.PivotFormula_typekey": PivotFormula;
        private constructor();
        _Default: string;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class PivotItem {
        private "Visio.PivotItem_typekey": PivotItem;
        private constructor();
        _Default: string;
        readonly Application: Application;
        Caption: string;
    ...
    class PivotItems {
        private "Visio.PivotItems_typekey": PivotItems;
        private constructor();
    ...
    class PivotLayout {
        private "Visio.PivotLayout_typekey": PivotLayout;
        private constructor();
    ...
    class PivotLine {
        private "Visio.PivotLine_typekey": PivotLine;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class PivotTable {
        private "Visio.PivotTable_typekey": PivotTable;
        private constructor();
        _Default: string;
    ...
    class PlotArea {
        private "Visio.PlotArea_typekey": PlotArea;
        private constructor();
    ...
    class Point {
        private "Visio.Point_typekey": Point;
        private constructor();
    ...
    class ProtectedViewWindow {
        private "Visio.ProtectedViewWindow_typekey": ProtectedViewWindow;
        private constructor();
        readonly _Default: string;
        Activate(): void;
        Caption: string;
    ...
    class Protection {
        private "Visio.Protection_typekey": Protection;
        private constructor();
    ...
    class PublishObject {
        private "Visio.PublishObject_typekey": PublishObject;
        private constructor();
        readonly Application: Application;
    ...
    class QueryTable {
        private "Visio.QueryTable_typekey": QueryTable;
        private constructor();
    ...
    class RecentFile {
        private "Visio.RecentFile_typekey": RecentFile;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Delete(): void;
    ...
    class Research {
        private "Visio.Research_typekey": Research;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class RoutingSlip {
        private "Visio.RoutingSlip_typekey": RoutingSlip;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class Scenario {
        private "Visio.Scenario_typekey": Scenario;
        private constructor();
        readonly Application: Application;
    ...
    class Series {
        private "Visio.Series_typekey": Series;
        private constructor();
    ...
    class SeriesLines {
        private "Visio.SeriesLines_typekey": SeriesLines;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        readonly Creator: XlCreator;
    ...
    class ShadowFormat {
        private "Visio.ShadowFormat_typekey": ShadowFormat;
        private constructor();
        readonly Application: any;
        Blur: number;
        readonly Creator: number;
    ...
    class Shape {
        private "Visio.Shape_typekey": Shape;
        private constructor();
    ...
    class ShapeNode {
        private "Visio.ShapeNode_typekey": ShapeNode;
        private constructor();
        readonly Application: any;
        readonly Creator: number;
    ...
    class Slicer {
        private "Visio.Slicer_typekey": Slicer;
        private constructor();
    ...
    class SlicerCache {
        private "Visio.SlicerCache_typekey": SlicerCache;
        private constructor();
        readonly Application: Application;
        ClearManualFilter(): void;
        readonly Creator: XlCreator;
    ...
    class SlicerCacheLevel {
        private "Visio.SlicerCacheLevel_typekey": SlicerCacheLevel;
        private constructor();
        readonly Application: Application;
        readonly Count: number;
        readonly Creator: XlCreator;
    ...
    class SlicerItem {
        private "Visio.SlicerItem_typekey": SlicerItem;
        private constructor();
        readonly Application: Application;
        readonly Caption: string;
        readonly Creator: XlCreator;
    ...
    class SmartTag {
        private "Visio.SmartTag_typekey": SmartTag;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class SmartTagAction {
        private "Visio.SmartTagAction_typekey": SmartTagAction;
        private constructor();
        readonly _Default: string;
    ...
    class SmartTagOptions {
        private "Visio.SmartTagOptions_typekey": SmartTagOptions;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class SmartTagRecognizer {
        private "Visio.SmartTagRecognizer_typekey": SmartTagRecognizer;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class Sort {
        private "Visio.Sort_typekey": Sort;
        private constructor();
        readonly Application: Application;
        Apply(): void;
        readonly Creator: XlCreator;
    ...
    class SortField {
        private "Visio.SortField_typekey": SortField;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        CustomOrder: any;
    ...
    class SoundNote {
        private "Visio.SoundNote_typekey": SoundNote;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Delete(): any;
    ...
    class SparkAxes {
        private "Visio.SparkAxes_typekey": SparkAxes;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class SparkColor {
        private "Visio.SparkColor_typekey": SparkColor;
        private constructor();
        readonly Application: Application;
        readonly Color: FormatColor;
        readonly Creator: XlCreator;
    ...
    class SparkHorizontalAxis {
        private "Visio.SparkHorizontalAxis_typekey": SparkHorizontalAxis;
        private constructor();
        readonly Application: Application;
    ...
    class Sparkline {
        private "Visio.Sparkline_typekey": Sparkline;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Location: Range;
    ...
    class SparklineGroup {
        private "Visio.SparklineGroup_typekey": SparklineGroup;
        private constructor();
        readonly Application: Application;
    ...
    class SparkPoints {
        private "Visio.SparkPoints_typekey": SparkPoints;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class SparkVerticalAxis {
        private "Visio.SparkVerticalAxis_typekey": SparkVerticalAxis;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class Speech {
        private "Visio.Speech_typekey": Speech;
        private constructor();
    ...
    class SpellingOptions {
        private "Visio.SpellingOptions_typekey": SpellingOptions;
        private constructor();
    ...
    class Style {
        private "Visio.Style_typekey": Style;
        private constructor();
        readonly _Default: string;
        AddIndent: boolean;
        readonly Application: Application;
    ...
    class TableStyle {
        private "Visio.TableStyle_typekey": TableStyle;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        readonly BuiltIn: boolean;
    ...
    class TableStyleElement {
        private "Visio.TableStyleElement_typekey": TableStyleElement;
        private constructor();
        readonly Application: Application;
        readonly Borders: Borders;
        Clear(): void;
    ...
    class TextEffectFormat {
        private "Visio.TextEffectFormat_typekey": TextEffectFormat;
        private constructor();
    ...
    class TextFrame {
        private "Visio.TextFrame_typekey": TextFrame;
        private constructor();
        readonly Application: Application;
        AutoMargins: boolean;
        AutoSize: boolean;
    ...
    class TextFrame2 {
        private "Visio.TextFrame2_typekey": TextFrame2;
        private constructor();
        readonly Application: any;
    ...
    class ThreeDFormat {
        private "Visio.ThreeDFormat_typekey": ThreeDFormat;
        private constructor();
        readonly Application: any;
    ...
    class TickLabels {
        private "Visio.TickLabels_typekey": TickLabels;
        private constructor();
        Alignment: number;
        readonly Application: Application;
        AutoScaleFont: any;
    ...
    class Toolbar {
        private "Visio.Toolbar_typekey": Toolbar;
        private constructor();
        readonly Application: Application;
        readonly BuiltIn: boolean;
        readonly Creator: XlCreator;
    ...
    class ToolbarButton {
        private "Visio.ToolbarButton_typekey": ToolbarButton;
        private constructor();
        readonly Application: Application;
        readonly BuiltIn: boolean;
        BuiltInFace: boolean;
    ...
    class Top10 {
        private "Visio.Top10_typekey": Top10;
        private constructor();
        readonly Application: Application;
        readonly AppliesTo: Range;
        readonly Borders: Borders;
    ...
    class TreeviewControl {
        private "Visio.TreeviewControl_typekey": TreeviewControl;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Drilled: any;
    ...
    class Trendline {
        private "Visio.Trendline_typekey": Trendline;
        private constructor();
        readonly Application: Application;
        Backward: number;
        Backward2: number;
    ...
    class UniqueValues {
        private "Visio.UniqueValues_typekey": UniqueValues;
        private constructor();
        readonly Application: Application;
        readonly AppliesTo: Range;
        readonly Borders: Borders;
    ...
    class UpBars {
        private "Visio.UpBars_typekey": UpBars;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        readonly Creator: XlCreator;
    ...
    class UserAccess {
        private "Visio.UserAccess_typekey": UserAccess;
        private constructor();
        AllowEdit: boolean;
        Delete(): void;
        readonly Name: string;
    ...
    class Validation {
        private "Visio.Validation_typekey": Validation;
        private constructor();
    ...
    class ValueChange {
        private "Visio.ValueChange_typekey": ValueChange;
        private constructor();
    ...
    class VPageBreak {
        private "Visio.VPageBreak_typekey": VPageBreak;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Delete(): void;
    ...
    class Walls {
        private "Visio.Walls_typekey": Walls;
        private constructor();
        readonly Application: Application;
        readonly Border: Border;
        ClearFormats(): any;
    ...
    class Watch {
        private "Visio.Watch_typekey": Watch;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        Delete(): void;
    ...
    class WebOptions {
        private "Visio.WebOptions_typekey": WebOptions;
        private constructor();
        AllowPNG: boolean;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class Window {
        private "Visio.Window_typekey": Window;
        private constructor();
    ...
    class Workbook {
        private "Visio.Workbook_typekey": Workbook;
        private constructor();
        __PrintOut(
            From?: any,
            To?: any,
    ...
    class WorkbookConnection {
        private "Visio.WorkbookConnection_typekey": WorkbookConnection;
        private constructor();
        _Default: string;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class Worksheet {
        private "Visio.Worksheet_typekey": Worksheet;
        private constructor();
        __PrintOut(
            From?: any,
            To?: any,
    ...
    class WorksheetFunction {
        private "Visio.WorksheetFunction_typekey": WorksheetFunction;
        private constructor();
        _WSFunction(
            Arg1?: any,
            Arg2?: any,
    ...
    class WorksheetView {
        private "Visio.WorksheetView_typekey": WorksheetView;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        DisplayFormulas: boolean;
    ...
    class XmlDataBinding {
        private "Visio.XmlDataBinding_typekey": XmlDataBinding;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        ClearSettings(): void;
    ...
    class XmlMap {
        private "Visio.XmlMap_typekey": XmlMap;
        private constructor();
        readonly _Default: string;
        AdjustColumnWidth: boolean;
    ...
    class XmlNamespace {
        private "Visio.XmlNamespace_typekey": XmlNamespace;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        readonly Creator: XlCreator;
    ...
    class XmlSchema {
        private "Visio.XmlSchema_typekey": XmlSchema;
        private constructor();
        readonly Application: Application;
        readonly Creator: XlCreator;
        readonly Name: string;
    ...
    class XPath {
        private "Visio.XPath_typekey": XPath;
        private constructor();
        readonly _Default: string;
        readonly Application: Application;
        Clear(): void;
...
interface EnumeratorConstructor {
    ...
    new<T>(sheets: Visio.Sheets<T>): Enumerator<T>;
}

interface ActiveXObject {
    on(
        obj: Visio.Application,
        event: "GetIDsOfNames",
        argNames: ["riid", "rgszNames", "cNames", "lcid", "rgdispid"],
        handler: (
            this: Visio.Application,
            parameter: {
                readonly riid: stdole.GUID;
    ...
    on(
        ...
        argNames: ["pctinfo"],
        handler: (this: Visio.Application, parameter: { pctinfo: number }) => void,
    ): void;
    on(
        obj: Visio.Application,
        event: "Invoke",
        argNames: Visio.EventHelperTypes.Application_Invoke_ArgNames,
        handler: (this: Visio.Application, parameter: Visio.EventHelperTypes.Application_Invoke_Parameter) => void,
    ): void;
    on(
        obj: Visio.Application,
        event:
            ...
            | "WorkbookOpen",
        argNames: ["Wb"],
        handler: (this: Visio.Application, parameter: { readonly Wb: Visio.Workbook }) => void,
    ): void;
    on(
        obj: Visio.Application,
        event:
        ...
        argNames: ["Pvw"],
        handler: (this: Visio.Application, parameter: { readonly Pvw: Visio.ProtectedViewWindow }) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: {
                readonly Pvw: Visio.ProtectedViewWindow;
                readonly Reason: Visio.XlProtectedViewCloseReason;
                Cancel: boolean;
            },
        ) => void,
    ): void;
    on(
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Pvw: Visio.ProtectedViewWindow; Cancel: boolean },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (this: Visio.Application, parameter: { readonly riid: stdole.GUID; ppvObj: undefined }) => void,
    ): void;
    on(
        obj: Visio.Application,
        event: "SheetActivate" | "SheetCalculate" | "SheetDeactivate",
        argNames: ["Sh"],
        handler: (this: Visio.Application, parameter: { readonly Sh: Visio.Chart | Visio.Worksheet }) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Sh: Visio.Worksheet; readonly Target: Visio.Range; Cancel: boolean },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Sh: Visio.Worksheet; readonly Target: Visio.Range },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Sh: Visio.Worksheet; readonly Target: Visio.Hyperlink },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: {
                readonly Sh: Visio.Worksheet;
                readonly TargetPivotTable: Visio.PivotTable;
                readonly TargetRange: Visio.Range;
            },
        ) => void,
    ): void;
    on(
    ...
    on(
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Sh: Visio.Worksheet; readonly Target: Visio.PivotTable },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Wb: Visio.Workbook; readonly Wn: Visio.Window },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Wb: Visio.Workbook; readonly Success: boolean },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: {
                readonly Wb: Visio.Workbook;
                readonly Map: Visio.XmlMap;
                readonly Url: string;
                readonly Result: Visio.XlXmlExportResult;
            },
        ) => void,
    ): void;
    on(
        ...
        handler: (
            ...
            parameter: {
                ...
                readonly Result: Visio.XlXmlImportResult;
            },
        ) => void,
    ): void;
    on(
        ...
        argNames: ["Wb", "Cancel"],
        handler: (this: Visio.Application, parameter: { readonly Wb: Visio.Workbook; Cancel: boolean }) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Wb: Visio.Workbook; readonly SaveAsUI: boolean; Cancel: boolean },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
    ...
    on(
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Wb: Visio.Workbook; readonly Ch: Visio.Chart },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Wb: Visio.Workbook; readonly Sh: Visio.Worksheet },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Wb: Visio.Workbook; readonly Target: Visio.PivotTable },
        ) => void,
    ): void;
    on(
        obj: Visio.Application,
    ...
    on(
        ...
        handler: (
            this: Visio.Application,
            parameter: { readonly Wb: Visio.Workbook; readonly SyncEventType: Office.MsoSyncEventType },
        ) => void,
    ): void;
    on(
        obj: Visio.Chart,
    ...
    on(
        ...
        argNames: ["Cancel"],
        handler: (this: Visio.Chart, parameter: { Cancel: boolean }) => void,
    ): void;
    on(
        obj: Visio.Chart,
        event: "GetIDsOfNames",
    ...
    on(
        ...
        event: "GetTypeInfoCount",
        argNames: ["pctinfo"],
        handler: (this: Visio.Chart, parameter: { pctinfo: number }) => void,
    ): void;
    on(
        obj: Visio.Chart,
        event: "Invoke",
        argNames: Visio.EventHelperTypes.Chart_Invoke_ArgNames,
        handler: (this: Visio.Chart, parameter: Visio.EventHelperTypes.Chart_Invoke_Parameter) => void,
    ): void;
    on(
        obj: Visio.Chart,
    ...
    on(
        ...
        event: "QueryInterface",
        argNames: ["riid", "ppvObj"],
        handler: (this: Visio.Chart, parameter: { readonly riid: stdole.GUID; ppvObj: undefined }) => void,
    ): void;
    on(
        obj: Visio.Chart,
        event: "Select",
    ...
    on(
        ...
        handler: (this: Visio.Chart, parameter: { readonly SeriesIndex: number; readonly PointIndex: number }) => void,
    ): void;
    on(
        obj: Visio.OLEObject,
        event: "GetIDsOfNames",
    ...
    on(
        ...
        event: "GetTypeInfoCount",
        argNames: ["pctinfo"],
        handler: (this: Visio.OLEObject, parameter: { pctinfo: number }) => void,
    ): void;
    on(
        obj: Visio.OLEObject,
        event: "Invoke",
        argNames: Visio.EventHelperTypes.OLEObject_Invoke_ArgNames,
        handler: (this: Visio.OLEObject, parameter: Visio.EventHelperTypes.OLEObject_Invoke_Parameter) => void,
    ): void;
    on(
        obj: Visio.OLEObject,
        event: "QueryInterface",
        argNames: ["riid", "ppvObj"],
        handler: (this: Visio.OLEObject, parameter: { readonly riid: stdole.GUID; ppvObj: undefined }) => void,
    ): void;
    on(
        obj: Visio.QueryTable,
        event: "AfterRefresh",
        argNames: ["Success"],
        handler: (this: Visio.QueryTable, parameter: { readonly Success: boolean }) => void,
    ): void;
    on(
        obj: Visio.QueryTable,
        event: "BeforeRefresh",
        argNames: ["Cancel"],
        handler: (this: Visio.QueryTable, parameter: { Cancel: boolean }) => void,
    ): void;
    on(
        obj: Visio.QueryTable,
        event: "GetIDsOfNames",
    ...
    on(
        ...
        event: "GetTypeInfoCount",
        argNames: ["pctinfo"],
        handler: (this: Visio.QueryTable, parameter: { pctinfo: number }) => void,
    ): void;
    on(
        obj: Visio.QueryTable,
        event: "Invoke",
        argNames: Visio.EventHelperTypes.QueryTable_Invoke_ArgNames,
        handler: (this: Visio.QueryTable, parameter: Visio.EventHelperTypes.QueryTable_Invoke_Parameter) => void,
    ): void;
    on(
        obj: Visio.QueryTable,
        event: "QueryInterface",
        argNames: ["riid", "ppvObj"],
        handler: (this: Visio.QueryTable, parameter: { readonly riid: stdole.GUID; ppvObj: undefined }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "AfterSave",
        argNames: ["Success"],
        handler: (this: Visio.Workbook, parameter: { readonly Success: boolean }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        ...
        handler: (
            this: Visio.Workbook,
            parameter: { readonly Map: Visio.XmlMap; readonly Url: string; readonly Result: Visio.XlXmlExportResult },
        ) => void,
    ): void;
    on(
        obj: Visio.Workbook,
    ...
    on(
        ...
        argNames: ["Cancel"],
        handler: (this: Visio.Workbook, parameter: { Cancel: boolean }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "BeforeSave",
        argNames: ["SaveAsUI", "Cancel"],
        handler: (this: Visio.Workbook, parameter: { readonly SaveAsUI: boolean; Cancel: boolean }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        ...
        handler: (
            this: Visio.Workbook,
            parameter: { readonly Map: Visio.XmlMap; readonly Url: string; Cancel: boolean },
        ) => void,
    ): void;
    on(
        obj: Visio.Workbook,
    ...
    on(
        ...
        event: "GetTypeInfoCount",
        argNames: ["pctinfo"],
        handler: (this: Visio.Workbook, parameter: { pctinfo: number }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "Invoke",
        argNames: Visio.EventHelperTypes.Workbook_Invoke_ArgNames,
        handler: (this: Visio.Workbook, parameter: Visio.EventHelperTypes.Workbook_Invoke_Parameter) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "NewChart",
        argNames: ["Ch"],
        handler: (this: Visio.Workbook, parameter: { readonly Ch: Visio.Chart }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "NewSheet" | "SheetActivate" | "SheetCalculate" | "SheetDeactivate",
        argNames: ["Sh"],
        handler: (this: Visio.Workbook, parameter: { readonly Sh: Visio.Chart | Visio.Worksheet }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "PivotTableCloseConnection" | "PivotTableOpenConnection",
        argNames: ["Target"],
        handler: (this: Visio.Workbook, parameter: { readonly Target: Visio.PivotTable }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "QueryInterface",
        argNames: ["riid", "ppvObj"],
        handler: (this: Visio.Workbook, parameter: { readonly riid: stdole.GUID; ppvObj: undefined }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
    ...
    on(
        ...
        handler: (this: Visio.Workbook, parameter: { readonly SyncEventType: Office.MsoSyncEventType }) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "WindowActivate" | "WindowDeactivate" | "WindowResize",
        argNames: ["Wn"],
        handler: (this: Visio.Workbook, parameter: { readonly Wn: Visio.Window }) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        event: "BeforeDoubleClick" | "BeforeRightClick",
        argNames: ["Target", "Cancel"],
        handler: (this: Visio.Worksheet, parameter: { readonly Target: Visio.Range; Cancel: boolean }) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        event: "Change" | "SelectionChange",
        argNames: ["Target"],
        handler: (this: Visio.Worksheet, parameter: { readonly Target: Visio.Range }) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        event: "FollowHyperlink",
        argNames: ["Target"],
        handler: (this: Visio.Worksheet, parameter: { readonly Target: Visio.Hyperlink }) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        event: "GetIDsOfNames",
    ...
    on(
        ...
        event: "GetTypeInfoCount",
        argNames: ["pctinfo"],
        handler: (this: Visio.Worksheet, parameter: { pctinfo: number }) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        event: "Invoke",
        argNames: Visio.EventHelperTypes.Worksheet_Invoke_ArgNames,
        handler: (this: Visio.Worksheet, parameter: Visio.EventHelperTypes.Worksheet_Invoke_Parameter) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        ...
        handler: (
            this: Visio.Worksheet,
            parameter: { readonly TargetPivotTable: Visio.PivotTable; readonly TargetRange: Visio.Range },
        ) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
    ...
    on(
        ...
        argNames: ["Target"],
        handler: (this: Visio.Worksheet, parameter: { readonly Target: Visio.PivotTable }) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        event: "QueryInterface",
        argNames: ["riid", "ppvObj"],
        handler: (this: Visio.Worksheet, parameter: { readonly riid: stdole.GUID; ppvObj: undefined }) => void,
    ): void;
    on(
        obj: Visio.Application,
        event: "AddRef" | "AfterCalculate" | "Release",
        handler: (this: Visio.Application, parameter: {}) => void,
    ): void;
    on(
        obj: Visio.Chart,
        event: "Activate" | "AddRef" | "Calculate" | "Deactivate" | "DragOver" | "DragPlot" | "Release" | "Resize",
        handler: (this: Visio.Chart, parameter: {}) => void,
    ): void;
    on(
        obj: Visio.OLEObject,
        event: "AddRef" | "GotFocus" | "LostFocus" | "Release",
        handler: (this: Visio.OLEObject, parameter: {}) => void,
    ): void;
    on(
        obj: Visio.QueryTable,
        event: "AddRef" | "Release",
        handler: (this: Visio.QueryTable, parameter: {}) => void,
    ): void;
    on(
        obj: Visio.Workbook,
        event: "Activate" | "AddinInstall" | "AddinUninstall" | "AddRef" | "Deactivate" | "Open" | "Release",
        handler: (this: Visio.Workbook, parameter: {}) => void,
    ): void;
    on(
        obj: Visio.Worksheet,
        event: "Activate" | "AddRef" | "Calculate" | "Deactivate" | "Release",
        handler: (this: Visio.Worksheet, parameter: {}) => void,
    ): void;
    set(
        obj: Visio.Chart,
        propertyName: "HasAxis",
        parameterTypes: [Visio.XlAxisType | undefined, Visio.XlAxisGroup | undefined],
        newValue: boolean,
    ): void;
    set(obj: Visio.ControlFormat, propertyName: "List", parameterTypes: [number], newValue: string): void;
    set(obj: Visio.ControlFormat, propertyName: "List", parameterTypes: never[], newValue: SafeArray<string>): void;
    set(obj: Visio.PageSetup, propertyName: "PrintQuality", parameterTypes: [number], newValue: number): void;
    set(obj: Visio.Workbook, propertyName: "Colors", parameterTypes: [number], newValue: number): void;
    set(obj: Visio.Range, propertyName: "Value", parameterTypes: [Visio.XlRangeValueDataType], newValue: any): void;
    set(
        obj: Visio.PivotField,
        propertyName: "Subtotals",
        parameterTypes: [Visio.PivotFieldSubtotal],
        newValue: boolean,
    ): void;
}
...
interface ActiveXObjectNameMap {
    ...
    "Visio.Chart": Visio.Chart;
    "Visio.Sheet": Visio.Worksheet;
}
